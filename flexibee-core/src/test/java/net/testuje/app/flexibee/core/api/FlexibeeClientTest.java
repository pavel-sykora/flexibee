...
import net.testuje.app.flexibee.core.api.domain.AccountMovementType;
import net.testuje.app.flexibee.core.api.domain.AddressBook;
import net.testuje.app.flexibee.core.api.domain.Bank;
import net.testuje.app.flexibee.core.api.domain.BankItem;
import net.testuje.app.flexibee.core.api.domain.InternalDocument;
import net.testuje.app.flexibee.core.api.domain.IssuedInvoice;
import net.testuje.app.flexibee.core.api.domain.IssuedInvoiceItem;
import net.testuje.app.flexibee.core.api.domain.IssuedInvoiceItems;
import net.testuje.app.flexibee.core.api.domain.IssuedInvoiceResponse;
import net.testuje.app.flexibee.core.api.domain.ItemType;
import net.testuje.app.flexibee.core.api.domain.Obligation;
import net.testuje.app.flexibee.core.api.domain.ObligationItem;
import net.testuje.app.flexibee.core.api.domain.ObligationItems;
import net.testuje.app.flexibee.core.api.domain.Order;
import net.testuje.app.flexibee.core.api.domain.PaymentStatus;
import net.testuje.app.flexibee.core.api.domain.Receivable;
import net.testuje.app.flexibee.core.api.domain.ReceivedInvoice;
import net.testuje.app.flexibee.core.api.domain.ReceivedInvoiceResponse;
import net.testuje.app.flexibee.core.api.domain.RoundingPrecision;
import net.testuje.app.flexibee.core.api.domain.VatRateKind;
